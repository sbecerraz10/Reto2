...
public class HTTPSWebUtilDomi {
    ...
    public String POSTrequesToFCM(String json) {
        try {
            URL page = new URL("https://fcm.googleapis.com/fcm/send");
            HttpsURLConnection connection = (HttpsURLConnection) page.openConnection();
            connection.setRequestMethod("POST");
            connection.setRequestProperty("Content-Type", "application/json");
            connection.setRequestProperty("Authorization", "key=AAAAWNS5FKc:APA91bHEbgF9m2mXR8zFRVJJpYPCvHP3CP_AJO_xWxdVc4IBb-baNQvil-9nFK4zGT15gWHqZBFEWR-F8jua7OdIeQfVjuprH1dnmNhwNmkyNkUgP0q7oj_sippoVQg1Dpe-3ClxXcHH");
            connection.setDoInput(true);
            connection.setDoOutput(true);
